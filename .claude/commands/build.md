...
[docs/build.md](../../docs/build.md); read it and follow it — do not
...
2. Read [docs/build.md](../../docs/build.md) and follow the section for
   that target and the user's platform.
3. Before running anything on Windows, confirm the preflight from
   [docs/build.md](../../docs/build.md) is satisfied (Developer Mode,
...
Trust [docs/build.md](../../docs/build.md). Tell the user this file is
