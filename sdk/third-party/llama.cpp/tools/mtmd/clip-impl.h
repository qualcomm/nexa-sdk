...
extern void llama_log_internal(ggml_log_level level, const char * format, ...);

#define LOG_DBG(...) llama_log_internal(GGML_LOG_LEVEL_DEBUG, __VA_ARGS__)
#define LOG_INF(...) llama_log_internal(GGML_LOG_LEVEL_INFO,  __VA_ARGS__)
#define LOG_WRN(...) llama_log_internal(GGML_LOG_LEVEL_WARN,  __VA_ARGS__)
#define LOG_ERR(...) llama_log_internal(GGML_LOG_LEVEL_ERROR, __VA_ARGS__)
#define LOG_CNT(...) llama_log_internal(GGML_LOG_LEVEL_CONT,  __VA_ARGS__) // same as INFO
