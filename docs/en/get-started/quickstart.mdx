...
- **Chipset** — GenieX targets Snapdragon. See [Supported platforms](/en/get-started/platforms) for chipsets across Windows ARM64, Android, and Linux ARM64.
- **Runtime** — your model dictates which runtime you take. See [Choose your runtime](/en/get-started/choose-runtime).
- **Models** — see [Supported models](/en/models/supported) for tested examples on each runtime.
