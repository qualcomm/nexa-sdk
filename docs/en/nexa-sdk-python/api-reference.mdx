---
title: "API Reference"
description: "Complete API documentation for all NexaAI Python SDK modules and classes."
---
...
- [macOS Guide](/en/nexa-sdk-python/platform-guides/macos) - Apple Silicon optimization
- [Windows x64 Guide](/en/nexa-sdk-python/platform-guides/windows-x64) - CPU/GPU acceleration  
- [Windows ARM64 Guide](/en/nexa-sdk-python/platform-guides/windows-arm64) - NPU acceleration
