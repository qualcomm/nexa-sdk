---
title: "Install"
description: "Install the GenieX Python SDK on Windows on Arm or Linux ARM64."
---

import Feedback from "/snippets/page-feedback.mdx";

The GenieX Python SDK ships as an ARM64 wheel for Windows on Arm and Linux ARM64.
