...
Source code lives at [`examples/android/`](https://github.com/qualcomm/GenieX/tree/main/examples/android) — open it in Android Studio and hit **Run ▶**. No phone? See [Testing without a physical device](/en/resources/faq#how-do-i-test-the-android-demo-without-a-physical-device).
