...
| 操作系统 | 芯片 | 接入方式 |
|---|---|---|
| **Windows ARM64** *（桌面端 / Copilot+ PC）* | <ul><li>骁龙 X Elite</li><li>骁龙 X2 Elite</li></ul> | <ul><li>[CLI](/cn/run/cli/quickstart)</li><li>[Python SDK](/cn/run/python/quickstart)</li><li>[本地服务器](/cn/run/cli/local-server)</li></ul> |
| **Android** *（移动端）* | <ul><li>骁龙 8 至尊版（`SM8750`）</li><li>骁龙 8 至尊版 Gen 5（`SM8850`）</li></ul> | <ul><li>[Android SDK](/cn/run/android/quickstart)（Kotlin，Maven Central）</li></ul> |
| **Linux ARM64** *（跃龙 IoT —— 摄像头、机器人、工业）* | <ul><li>跃龙 QCS9075</li></ul> | <ul><li>[原生安装](/cn/run/cli/install)</li><li>[Docker](/cn/run/linux/install)</li></ul> |
