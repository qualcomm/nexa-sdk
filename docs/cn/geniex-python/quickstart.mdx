...
如需快速上手，推荐参考 [Jupyter Notebook 指南](https://github.com/qcom-ai-hub/geniex/blob/main/examples/python/windows.ipynb)，其中提供了环境配置与 GenieX Python SDK 推理的逐步演示。
...
```powershell
$env:GENIEX_VERSION = "0.1.4"  # 示例版本号，请替换为您实际安装的版本
