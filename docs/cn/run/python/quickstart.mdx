...
- 了解[后端选择](/cn/get-started/choose-backend)——`qairt` 用于 AI Hub 模型包，`llama_cpp` 用于任意 GGUF。
...
#     model_name="qwen3_4b_instruct_2507",        # 与 AI Hub 上的 model id 一致
#     device_map="qairt",                         # QAIRT 必须使用
# )
...
<CardGroup cols={2}>
  ...
  <Card title="自带模型" href="/cn/models/bring-your-own" icon="cube">
    自定义 GGUF 与自行转换的 QAIRT 模型包。
  </Card>
</CardGroup>
